class Book < ApplicationRecord
  ...
  def self.sorted_by_favorites_and_without_favorites_created_this_week
    created_this_week.ordered_by_favorites_count.preload_user + 
    without_favorites.created_this_week.preload_user
  end

  def self.sorted_by_favorites
    with_favorites.ordered_by_favorites_count.preload_user +
      without_favorites.preload_user
  end
